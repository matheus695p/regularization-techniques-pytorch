...
Según [7] la útilización de schedulers ciclicos permité una mejor exploración de la función de costos, aumentando la probabilidad de descubrir mejores mínimos locales, sin embargo, ReduceLROnPlateu, nos permité llegar más rápido a un mínimo local y hacer la convergencia más rápido, probaré esta implementación primero, pero dejo arriba como definir cada una de estas classes de optimizadores.
